...
export default function CheckoutSteps(props) {
  return (
    // new style
    <div class="flex items-center justify-center space-x-4 mx-8 mt-4">
      <div class="flex flex-col items-center">
        ...
        <p class="mt-1 font-medium text-gray-900 whitespace-nowrap">Sign In</p>
      </div>
      ...
      <div class="flex flex-col items-center">
        ...
        <p class="mt-1 font-medium text-gray-900">Shipping</p>
      </div>
      ...
      <div class="flex flex-col items-center">
        ...
        >
          <span class="sr-only">Step 3</span>3
        </button>
        <p class="mt-1 font-medium text-gray-900">Payment</p>
      </div>
      ...
      <div class="flex flex-col items-center">
        ...
        >
          <span class="sr-only">Step 4</span>4
        </button>
        <p class="mt-1 font-medium text-gray-900 whitespace-nowrap">
          Place Order
        </p>
      </div>
    </div>
